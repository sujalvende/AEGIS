# AEGIS — Autonomous Emergency Guardian & Intelligence System

React + Vite + Tailwind CSS v4 project.

## Development Server

A Vite development server runs on `$PORT` (default 8443 or 5173).
...
- Export components as default exports where applicable.
